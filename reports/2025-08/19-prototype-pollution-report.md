# Technical Pentest Report — Lab 19 Prototype Pollution
...
**Primary Weakness:** Unsafe Merge Allowing Prototype Pollution  
**Severity:** High  
...
## 4. Finding Overview
### Unsafe Merge Allowing Prototype Pollution
**Severity:** High  
**Category:** Object Security

## 5. Description
The vulnerable version allowed behavior associated with **Unsafe Merge Allowing Prototype Pollution**. The application trusted data, state, or rendering paths in a way that introduced a security weakness. In the context of the lab, this behavior was sufficient to demonstrate the core vulnerability pattern and its practical impact.

## 6. Technical Details
The merge behavior accepted dangerous meta-properties that could modify shared object behavior. In JavaScript ecosystems, this class of issue can create subtle and far-reaching side effects.
...
## 8. Security Impact
Prototype pollution may alter downstream logic, break assumptions in authorization checks, or introduce security-impacting behavior in code that consumes polluted objects.
...
Block dangerous keys such as __proto__, constructor, and prototype, validate payload structure, and use safe merge strategies.
...
This simulated assessment confirmed the presence of **Unsafe Merge Allowing Prototype Pollution** in the vulnerable version and validated the intended mitigation approach in the fixed version. The lab effectively demonstrates both the offensive behavior and the secure development correction pattern.
...
### Review Note\nTechnical detail refined to better communicate indirect security consequences.
